<!DOCTYPE html>
 ...
 <head>
   ...
   <style type="text/tailwindcss">
     ...
     .empty-author-item {
    @apply text-sm rounded-md bg-gradient-to-bl from-purple-400 via-pink-500 to-red-500 py-10 px-4 text-center leading-6 text-slate-900 shadow-md shadow-black/5 ring-1 ring-slate-700/10;
     }
